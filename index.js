...
if(leadsfromlocalstorage){// rendering leads from local storage
    myleads=leadsfromlocalstorage
    render(myleads)
}

deleteEL.addEventListener('dblclick',function(){//delete-btn function
    localStorage.clear()
    myleads=[]
    render(myleads)
})

inputbtn.addEventListener("click",function(){ // function of save-input btn
...
savetabEL.addEventListener("click",function(){ // save-tab functioning
...
function render(leads){ // functioning of rendering
    let listitems=""
